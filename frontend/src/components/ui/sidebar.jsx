...
const SidebarProvider = React.forwardRef(({
  ...
  }, [isMobile, setOpenMobile, setOpenState]);
  ...
  const contextValue = React.useMemo(() => ({
    ...
    isMobile,
    toggleSidebar,
  }), [state, openState, setOpenState, openMobile, setOpenMobile, isMobile, toggleSidebar]);
...
const SidebarGroupLabel = forwardRef(({ className, asChild, ...props }, ref) => {
...
const SidebarGroupAction = forwardRef(({ className, asChild, ...props }, ref) => {
...
const SidebarMenuButton = forwardRef(
  ({ asChild, isActive, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
